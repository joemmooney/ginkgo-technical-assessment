...
6) Run 'bash local_build.txt' to run program.

After running the bash command it should run on 'localhost:3000'.  You can access the underlying database by navigating to 'localhost:8000/api/SearchProteins/'.
